...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("shark-305004_640.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_6.setPixmap(QtGui.QPixmap(_fromUtf8("shark-305004_640.png")))
